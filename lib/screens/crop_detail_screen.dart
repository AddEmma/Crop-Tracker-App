...
class CropDetailScreen extends StatelessWidget {
  ...
  Future<void> _updateStatus(BuildContext context, Crop crop, CropStatus newStatus) async {
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        subtitle: Text(
                          DateFormat('EEEE, MMM dd, yyyy').format(crop.plantingDate),
                        ),
                      ),
                      const Divider(),
                      ListTile(
                        ...
                        subtitle: Text(
                          DateFormat('EEEE, MMM dd, yyyy').format(crop.expectedHarvestDate),
                        ),
                      ),
                      const Divider(),
                      ListTile(
                        ...
                        subtitle: Text(
                          ...
                          style: TextStyle(
                            color: _getDaysUntilHarvest(crop).contains('overdue')
                                ? Colors.red
                                : null,
                          ),
                        ),
                ...
                if (crop.status != CropStatus.harvested) ...[
                  ...
                  Wrap(
                    ...
                    children: CropStatus.values.map((status) {
                      if (status == crop.status) return const SizedBox.shrink();
                      
                      return ElevatedButton.icon(
                        onPressed: () => _updateStatus(context, crop, status),
